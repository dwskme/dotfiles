local _, colors = pcall(require, 'user.theme.colors')
if not colors then
  return
end

local get_highlight = require('user.theme.utils').get_highlight
local set_highlight = require('user.theme.utils').set_highlight
